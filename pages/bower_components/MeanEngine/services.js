	...
	return {
		apicall:	function(options) {
			...
			*/
			...
			//console.log("url:",window.meanEngine.get('api').protocol+"://"+window.meanEngine.get('api').hostname+':'+window.meanEngine.get('api').port+'/api/'+api.endpoint+"/"+api.method+"/jsonp");
